...
import { aboutInfo, assets } from "../../public/assets/assets"
       ...
       <div className='flex flex-col md:flex-row items-center gap-12'>
         ...
         >
            <div className="rounded-2xl p-8">
                ...
                <p className="text-gray-300 mb-">  When I'm not coding, you can find me exploring new technologies, contributing to open-source projects, or sharing my knowledge through tech blogs and tutorials. I believe in continuous learning and pushing the boundaries of what's possible on the web.</p>
