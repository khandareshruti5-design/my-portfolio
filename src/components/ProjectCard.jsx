...
const ProjectCard = ({title, description, image, tech}) =>{
    return(
        <div className="bg-dark-300 rounded-2xl overflow-hidden hover:-translate-y-2 duration-300 cursor-pointer">
            <img src={image} alt={title} className="w-full h-60 pbject-cover"/>
            <div className="p-6 ">
