      ...
      <div className="container mx-auto px-6 flex flex-col md:flex-row items-center justify-between">
        ...
        <div className="md:w-1/2 mb-10 md:mb-0">
          ...
          <h1 className="text-5xl font-bold text-white">
            Hi, I'm <span className="text-purple-500">Shruti Khandare</span>
          </h1>
          ...
          <div className='flex space-x-4'>
              <a href="#projects" className='px-6 py-3 bg-purple-600 rounded-lg font-medium hover:bg-purple-700 transition duration-300'>view work</a>
               <a href="#contact" className='px-6 py-3 border border-purple-600 rounded-lg font-medium hover:bg-purple/20 transition duration-300'>contact me</a>
          </div>
        ...
        <div className='md:w-1/2 flex justify-center'>
           <div className='relative w-64 h-64 md:w-80 md:h-80'>
              <div className='basolute inset-0 rounded-full bg-gradient-to-r from-purple to-pink opacity-70'>
                  ...
                  src="/assets/profile.avif" alt="profile" />
              </div>
           </div>
        </div>
